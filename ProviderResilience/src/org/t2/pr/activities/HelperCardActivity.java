...
/**
 * The Class HelperCardActivity.
 */
public class HelperCardActivity extends ABSActivity implements SimpleGestureListener{
...
//			cardIndex--;
//		else
//			cardIndex = (cardNames.size() -1);
//
//		int resID = getResources().getIdentifier(cardNames.get(cardIndex), "drawable", "org.t2.pr");
...
private void LoadCards()
	{
		//Load cards
		cardNames = getResources().getStringArray(R.array.PROQOLCard);    
	}
