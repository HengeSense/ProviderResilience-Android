 ...
 *
 * Steveo - disabled accessibility if ICS or higher.
 * 
 * @author robbiev
 * 
 */
public class AccessibleWebView extends WebView 
{
	...
	private void init() 
	{
		if(android.os.Build.VERSION.SDK_INT >= 14 )
		{
			...
			this.setBackgroundColor(Color.BLACK); // make the bg transparent
		...
		else
		{
			...
			awebViewClient = new AccessibleWebViewClient();

			this.setWebViewClient(awebViewClient);
			this.setWebChromeClient(new WebChromeClient());
